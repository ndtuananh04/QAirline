...
CREATE TABLE `booking_histories` (
  ...
  CONSTRAINT `fk_booking_ticket` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`ticket_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `promotions` (
  ...
  `code_promotion` varchar(45) NOT NULL,
  `count` int NOT NULL,
  `title` text NOT NULL,
  ...
  CONSTRAINT `fk_promotions_user_id` FOREIGN KEY (`promotion_id`) REFERENCES `account` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `promotions` VALUES (1,'',0,'1','Hello','2004-05-19 00:00:00','2004-05-21 00:00:00');
...
INSERT INTO `revoked_tokens` VALUES (1,'fde00b35-ed97-40c8-ba98-011060c7b7bc'),(2,'2cea57b0-7d35-4752-89aa-d38290ead9a8'),(3,'2cea57b0-7d35-4752-89aa-d38290ead9a8'),(4,'2cea57b0-7d35-4752-89aa-d38290ead9a8'),(5,'2cea57b0-7d35-4752-89aa-d38290ead9a8'),(6,'2cea57b0-7d35-4752-89aa-d38290ead9a8'),(7,'50b73088-309f-4ad4-8038-e57e5ca0d007'),(8,'50b73088-309f-4ad4-8038-e57e5ca0d007'),(9,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(10,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(11,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(12,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(13,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(14,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(15,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(16,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(17,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(18,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(19,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(20,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(21,'6672254a-9ddb-4782-9ef3-cc5a44c2c5e7'),(22,'48551d6e-c73e-4ea8-ac01-37ba5b19d2e9');
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `fk_ticket_user_id` FOREIGN KEY (`ticket_id`) REFERENCES `account` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-27 23:41:25
